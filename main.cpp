...
{
  display_cell(m.c_depart);
  vibes::drawCircle(m.c_depart->m_x+0.5, m.c_depart->m_y+0.5, 0.25, "black[green]");
  vibes::drawCircle(m.c_arrivee->m_x+0.5, m.c_arrivee->m_y+0.5, 0.25, "black[red]");
}
